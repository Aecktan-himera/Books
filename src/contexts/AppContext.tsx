...
import { AppState, AppAction, AppContextType, Book, BookContent, TextSettings, Filters } from '../types';
...
const loadInitialState = (): AppState => ({
    ...
    defaultTextSettings: JSON.parse(localStorage.getItem('defaultTextSettings') || '{"color":"black","size":"medium","bold":false}') as TextSettings,
});
...
export function AppProvider({ children }: { children: React.ReactNode }) {
    ...
    // Мемоизированные колбэки с типами
